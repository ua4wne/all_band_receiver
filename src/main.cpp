...
boolean changed_f = false;           // Переменная changed_f, отражающая факт изменения частоты настройки (1 - частота изменилась)
boolean changed_mod = false;         // Переменная changed_mod, отражающая факт смены демодулятора (1 - демодулятор переключен)
boolean LPF_HPF = false;             // Переменная LPF_HPF (0 - включен ФНЧ (LPF); 1 - включен ФВЧ (HPF))
